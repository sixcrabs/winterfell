package io.github.sixcrabs.winterfell.starter.as.security.ratelimit;
...
public class RateLimiterAspect {
    ...
    @Pointcut(value = "@annotation(io.github.sixcrabs.winterfell.starter.as.security.ratelimit.RateLimiter)")

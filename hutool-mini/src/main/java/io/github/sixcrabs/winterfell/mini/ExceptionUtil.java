...
import static io.github.sixcrabs.winterfell.mini.StringUtil.*;
...
//		return (new Throwable()).getStackTrace();
	...
	public static String stacktraceToOneLineString(Throwable throwable, int limit){
		...
		replaceCharToStrMap.put(C_CR, SPACE);
		replaceCharToStrMap.put(C_LF, SPACE);
		replaceCharToStrMap.put(C_TAB, SPACE);

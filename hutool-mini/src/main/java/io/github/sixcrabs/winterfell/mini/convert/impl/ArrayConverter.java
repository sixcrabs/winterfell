...
import io.github.sixcrabs.winterfell.mini.collection.IterUtil;
import io.github.sixcrabs.winterfell.mini.StringUtil;
import io.github.sixcrabs.winterfell.mini.convert.AbstractConverter;
import io.github.sixcrabs.winterfell.mini.convert.ConverterRegistry;
...
public class ArrayConverter extends AbstractConverter<Object> {
    ...
    public ArrayConverter(Class<?> targetType) {
        if (null == targetType) {
            ...
            AssertUtil.isTrue(targetType.isArray(), "Target type must be a array!");
        }

package io.github.sixcrabs.winterfell.mini.convert;

import io.github.sixcrabs.winterfell.mini.AssertUtil;
...
import io.github.sixcrabs.winterfell.mini.convert.impl.CollectionConverter;
import io.github.sixcrabs.winterfell.mini.convert.impl.GenericEnumConverter;
import io.github.sixcrabs.winterfell.mini.convert.impl.MapConverter;
...
//    }
    ...
    public static String strToUnicode(String strText) {
        ...
        for (int i = 0; i < strLength; i++) {
            ...
            if (strHexLen > 0 && strHexLen < 4) {
                str.append(StringUtil.repeat('0', 4 - strHexLen));
            }
            str.append(strHex);
        }
        return str.toString();
    ...
    public static String unicodeToStr(String unicode) {
        ...
        String[] hex = StringUtil.split(unicode, "\\u");
...
//    }
    ...
    public static long convertTime(long sourceDuration, TimeUnit sourceUnit, TimeUnit destUnit) {
        AssertUtil.notNull(sourceUnit, "sourceUnit is null !");
        AssertUtil.notNull(destUnit, "destUnit is null !");

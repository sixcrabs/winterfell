package io.github.sixcrabs.winterfell.mini.crypto.digest.otp;


import io.github.sixcrabs.winterfell.mini.RandomUtil;
import io.github.sixcrabs.winterfell.mini.codec.Base32Util;
...
public class HOTP {
	...
	public static String generateSecretKey(int numBytes) {
		return Base32Util.encode(RandomUtil.getSHA1PRNGRandom(RandomUtil.randomBytes(256)).generateSeed(numBytes));
	}

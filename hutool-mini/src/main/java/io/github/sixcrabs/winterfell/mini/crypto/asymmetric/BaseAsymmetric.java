package io.github.sixcrabs.winterfell.mini.crypto.asymmetric;

import io.github.sixcrabs.winterfell.mini.AssertUtil;
import io.github.sixcrabs.winterfell.mini.codec.Base64Util;
import io.github.sixcrabs.winterfell.mini.crypto.CryptoException;
import io.github.sixcrabs.winterfell.mini.crypto.KeyUtil;
...
public class BaseAsymmetric<T extends BaseAsymmetric<T>> implements Serializable {
	...
	public String getPublicKeyBase64() {
		...
		return (null == publicKey) ? null : Base64Util.encode(publicKey.getEncoded());
	}
	...
	public String getPrivateKeyBase64() {
		...
		return (null == privateKey) ? null : Base64Util.encode(privateKey.getEncoded());
	}
	...
	public T setKey(Key key) {
		AssertUtil.notNull(key, "key must be not null !");

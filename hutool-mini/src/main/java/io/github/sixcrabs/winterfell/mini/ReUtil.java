package io.github.sixcrabs.winterfell.mini;

import io.github.sixcrabs.winterfell.mini.comparator.CompareUtil;
import io.github.sixcrabs.winterfell.mini.convert.Convert;
import io.github.sixcrabs.winterfell.mini.func.FunctionCall;
...
public class ReUtil {
     ...
     * @since 5.7.15
     */
    public static void get(Pattern pattern, CharSequence content, Consumer<java.util.regex.Matcher> consumer) {
     ...
     * @since 4.2.2
     */
    public static String replaceAll(CharSequence str, Pattern pattern, FunctionCall<Matcher, String> replaceFun) {
     ...
     * @since 4.2.2
     */
    public static String replaceAll(CharSequence str, String regex, FunctionCall<Matcher, String> replaceFun) {

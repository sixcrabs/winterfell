package io.github.sixcrabs.winterfell.mini.io;

import io.github.sixcrabs.winterfell.mini.AssertUtil;
import io.github.sixcrabs.winterfell.mini.SrcToDestCopier;
...
public class FileCopier extends SrcToDestCopier<File, FileCopier> {
    ...
    public File copy() throws IORuntimeException {
        // check
        AssertUtil.notNull(src, "Source File is null !");
        if (!src.exists()) {
            throw new IORuntimeException("File not exist: " + src);
        }
        AssertUtil.notNull(dest, "Destination File or directiory is null !");

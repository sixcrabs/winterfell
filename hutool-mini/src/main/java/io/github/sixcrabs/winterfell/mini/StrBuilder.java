...
import static io.github.sixcrabs.winterfell.mini.StringUtil.C_SPACE;
import static io.github.sixcrabs.winterfell.mini.StringUtil.EMPTY;
...
public class StrBuilder implements CharSequence, Appendable, Serializable {
	...
	private void moveDataAfterIndex(int index, int length) {
		...
		if (index < this.position) {
			...
			Arrays.fill(this.value, this.position, index, C_SPACE);
		}
		// 不位移
	}

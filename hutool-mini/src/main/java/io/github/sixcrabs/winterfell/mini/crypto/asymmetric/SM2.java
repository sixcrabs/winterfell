...
import io.github.sixcrabs.winterfell.mini.crypto.BCUtil;
import io.github.sixcrabs.winterfell.mini.crypto.CryptoException;
import io.github.sixcrabs.winterfell.mini.crypto.ECKeyUtil;
...
public class SM2 extends AbstractAsymmetricCrypto<SM2> {
	...
	public byte[] decrypt(byte[] data, CipherParameters privateKeyParameters) throws CryptoException {
		AssertUtil.isTrue(data.length > 1, "Invalid SM2 cipher text, must be at least 1 byte long");

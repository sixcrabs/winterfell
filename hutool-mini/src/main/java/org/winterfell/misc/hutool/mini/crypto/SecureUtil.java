...
import org.winterfell.misc.hutool.mini.crypto.asymmetric.AsymmetricAlgorithm;
import org.winterfell.misc.hutool.mini.crypto.asymmetric.RSA;
import org.winterfell.misc.hutool.mini.crypto.asymmetric.Sign;
import org.winterfell.misc.hutool.mini.crypto.asymmetric.SignAlgorithm;
import org.winterfell.misc.hutool.mini.crypto.digest.*;
import org.winterfell.misc.hutool.mini.crypto.symmetric.*;
import org.winterfell.misc.hutool.mini.crypto.symmetric.fpe.FPE;
...
public class SecureUtil {
	...
	public static HMac hmac(HmacAlgorithm algorithm, String key) {
		return hmac(algorithm, StringUtil.isNotEmpty(key)? StringUtil.utf8Bytes(key): null);
	}
	...
	public static HMac hmacMd5(String key) {
		return hmacMd5(StringUtil.isNotEmpty(key)? StringUtil.utf8Bytes(key): null);
	}
	...
	public static HMac hmacSha1(String key) {
		return hmacSha1(StringUtil.isNotEmpty(key)? StringUtil.utf8Bytes(key): null);
	}
	...
	public static HMac hmacSha256(String key) {
		return hmacSha256(StringUtil.isNotEmpty(key)? StringUtil.utf8Bytes(key): null);
	}
	...
	public static byte[] decode(String key) {
		...
		return (decodeHex && ValidatorUtil.isHex(key)) ? HexUtil.decodeHex(key) : Base64Util.decode(key);
	}

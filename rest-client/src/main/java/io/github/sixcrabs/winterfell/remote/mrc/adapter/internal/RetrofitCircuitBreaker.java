package io.github.sixcrabs.winterfell.remote.mrc.adapter.internal;
...
public interface RetrofitCircuitBreaker {
    ...
    static <T> Call<T> decorateCall(final CircuitBreaker circuitBreaker, final Call<T> call,
        ...
        return new RetrofitCircuitBreaker.CircuitBreakingCall<>(call, circuitBreaker, responseSuccess);
    }
    ...
    class CircuitBreakingCall<T> extends DecoratedCall<T> {
        ...
        @Override
        public Call<T> clone() {
            return new RetrofitCircuitBreaker.CircuitBreakingCall<>(call.clone(), circuitBreaker, responseSuccess);
        }
    }
}
 ...
 */
package io.github.sixcrabs.winterfell.indigo.renderer.ext.pptx.support;
...
public enum SsPictureType {
     ...
     * @return
     */
    public static SsPictureType suggestFileType(String imgFile) {
        SsPictureType format = null;
